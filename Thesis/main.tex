...
{\Large Name Surnames\par}

\vspace{2.2cm}

{\Huge\bfseries Title of the Master’s Thesis\par}
...
{\large
Supervisors: Dr. Name1 Surnames1 (affiliation1) and Dr. Name2 Surnames2 (affiliation2)\par
\vspace{0.6cm}
Tutor: Dr. Name3 Surnames3 (affiliation3) % <-- delete this line if not needed
\par}
...
\vfill
  ...
  \begin{figure}[H]
    	\centering
    	\includegraphics[width=0.7\columnwidth]{figures/Set_images_cover_TFM.png}
    \end{figure}
...
% Comment this out if you do NOT want the title repeated on page 2
\maketitle
